...
urlpatterns = [       
        ...
        path('service/add/', HodViews.ServiceCreateUpdateView.as_view(), name='admin_service_add'),
        path('service/<int:pk>/edit/', HodViews.ServiceCreateUpdateView.as_view(), name='admin_service_edit'),
        path('service/list/', HodViews.ServiceListView.as_view(), name='admin_service_list'), 
        path('service/<int:pk>/delete/', HodViews.ServiceDeleteView.as_view(), name='admin_service_delete'),
